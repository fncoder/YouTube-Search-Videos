...
var Buttons = function (_React$Component) {
  ...
  _createClass(Buttons, [{
    ...
    value: function render() {
      ...
      var checkToken = this.props.currentData.hasOwnProperty('prevPageToken');
      var btnPrev = null;
      ...
      if (checkToken) {
        btnPrev = _react2.default.createElement(
          ...
          { onClick: function onClick() {
              return _this2.props.nextToken('prevPageToken');
            }, className: 'btn next-rev' },
          'Prev'
        );
      } else {
        btnPrev = null;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { onClick: function onClick() {
              return _this2.props.nextToken('nextPageToken');
